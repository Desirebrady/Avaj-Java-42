...
public class Simulator {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while ((strLine = extracted(br).readLine()) != null) {
                ...
                // For the other lines, we check for the format <String> <String> <Int> <Int>
                // <Int>
                else {
                    ...
                    try {
                        aircraftFactory
                                .newAircraft(splitted[0], splitted[1], Integer.parseInt(splitted[2]),
    ...
    private static BufferedReader extracted(BufferedReader br) {
        return br;
    }
}
